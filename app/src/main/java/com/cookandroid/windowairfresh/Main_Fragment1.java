...
public class Main_Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SharedPreferences pref = getContext().getSharedPreferences("help", getContext().MODE_PRIVATE);
        String help_show = pref.getString("help_show", "");

        if(help_show=="")
            help_show="0";
        // 파일 위치
        //   "0"-help show  ,  "1"=help don't show
